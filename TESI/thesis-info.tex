...
% Frontespizio
%**************************************************************
\newcommand{\myName}{Filippo Gamberoni}                         % autore
...
\newcommand{\myProf}{Luigi De Giovanni}                                % relatore
\newcommand{\myLocation}{Padova}                                % dove
\newcommand{\myAA}{2015-2016}                                   % anno accademico
\newcommand{\myTime}{Dic 2016}                                  % quando
...
\crest{\includegraphics[width=0.4\textwidth]{logo-unipd}}
